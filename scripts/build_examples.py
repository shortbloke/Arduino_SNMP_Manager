...
def environments(group):
    ...
    legacy = {"single_esp8266", "single_esp32", "multiple_esp8266", "multiple_esp32", "ethernet_esp8266"}
    if group == "legacy":
...
if __name__ == "__main__":
    ...
    subprocess.run(["pio", "run", "-d", "tests/examples"] +
                   [arg for name in selected for arg in ("-e", name)], check=True)
